...
const PERP_TICKER_FIELDS = ['contract', 'mark_price', 'index_price', 'last', 'change_percentage', 'volume_24h_quote', 'volume_24h_usd', 'total_size', 'funding_rate', 'funding_rate_indicative', 'highest_bid', 'lowest_ask'];
